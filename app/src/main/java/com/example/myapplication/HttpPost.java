...
//        Log.e("호출","호출");
    ...
    public void test(Context context,Response.Listener listener){
...
//        Log.e("호출","호출");
        ...
        String url = "http://34.22.97.253:8080/ranking"; // POST 요청을 보낼 URL     -- POST 요청을 보낼 URL이 왜 필요한가? 스프링이 웹에서 실행되는 걸까..?
